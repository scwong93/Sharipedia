...
RSpec.describe WikisController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "assigns the new wiki to @wiki" do
      wiki :create, params: { title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false }
  ...
  describe "PUT update" do
    ...
    it "redirects to the updated wiki" do
      ...
      put :update, params: { id: my_post.id, wiki: { title: new_title, body: new_body, private: false }  }
